(() => {
    ...
    const siteVersion = "wow-launch-2026-05-20";
    ...
    function initPremiumScroll() {
        ...
        tl.to("#hero-text", { opacity: 0, y: -40, scale: 0.96, filter: "blur(10px)", duration: 0.65 }, 0)
            .to(phoneDrop, {
                y: -88,
                opacity: 1,
                rotationZ: 0,
            ...
            .to(phoneDrop, { y: -128, rotationZ: -4, rotationX: 6, duration: 2.5, ease: "none" }, 3)
            ...
            .to(phoneDrop, { y: -88, rotationZ: 0, rotationX: 0, duration: 2.5, ease: "none" }, 5.5)
            ...
            .to("#text-mid", { opacity: 0, y: -60, filter: "blur(10px)", duration: 1.5, ease: "power2.in" }, 6.5)
            ...
            .to(phoneDrop, { y: -128, rotationZ: 4, rotationX: -6, duration: 2.5, ease: "none" }, 8)
            ...
            .to(phoneDrop, { y: -88, rotationZ: 0, rotationX: 0, duration: 2.5, ease: "none" }, 10.5)
            ...
            .to(phoneDrop, { scale: 1.4, y: -150, "--ring-opacity": 0.9, "--edge-glow": 1, "--aura-scale": 1.24, duration: 2, ease: "power2.inOut" }, 13.5)
            .to("#text-final", { opacity: 0, y: -80, filter: "blur(10px)", duration: 1.5, ease: "power2.in" }, 13.5)
            .to("#transition-wash", { opacity: 1, duration: 1.5, ease: "power2.inOut" }, 14)
            .to(phoneDrop, { opacity: 0, scale: 2, filter: "blur(20px)", duration: 1.5, ease: "power3.in" }, 14.5)
